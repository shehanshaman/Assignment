...
Bits 08-15 : Source Operand 2	: Given as a register number (0-7)
Bits 00-07 : Source Operand 1	: Given as a register number (0-7), or an 8-bit memory address as an immediate value in hex (e.g. 0xFF)
...
Generated output file	: <your_assembly_file_nae>.machine
*/
